...
public class Practica2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "T__26", "T__27", "T__28", "T__29", "T__30", "IDENT", "CONSTINT", 
			"CONSTFLOAT", "DECIMAL_INT", "DECIMAL_REAL", "OCTAL_INT", "OCTAL_REAL", 
			"HEXA_INT", "HEXA_REAL", "CONSTLIT", "GPC", "GPC2", "JUMP", "ESC_SEQ", 
			"LETTER", "HEX_DIGIT", "DIGIT"
		};
	}
	...
	public Practica2Lexer(CharStream input) {
		super(input);
